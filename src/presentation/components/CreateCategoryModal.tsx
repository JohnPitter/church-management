            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  className="w-full px-3 py-1 text-sm border border-gray-300 rounded focus:ring-indigo-500 focus:border-indigo-500"
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-400">
                    {formData.type === TransactionType.INCOME ? 'Receita' : 'Despesa'}
                  </div>
                </div>
              </div>
            </div>
