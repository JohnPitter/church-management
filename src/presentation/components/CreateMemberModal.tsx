...
export const CreateMemberModal: React.FC<CreateMemberModalProps> = ({
  ...
  const [formData, setFormData] = useState({
    ...
    memberType: MemberType.Member, // Novo campo: tipo de membro
    photoURL: '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const memberData: any = {
        ...
        memberType: formData.memberType, // Novo campo: tipo de membro
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    required
                  >
                    <option value={MemberType.Member}>Membro (pode assinar atas)</option>
                    <option value={MemberType.Congregant}>Congregado (não pode assinar atas)</option>
                  </select>
                  <p className="text-xs text-gray-500 mt-1">
                    Congregados aparecem nos relatórios mas não podem assinar documentos oficiais
                  </p>
                </div>
