// Página de Setup Inicial - Criação do primeiro admin
      ...
      <div className="max-w-md w-full bg-white rounded-lg shadow-xl p-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4">
              <div className="flex">
                ...
                <div>
                  <p className="text-sm text-yellow-800 font-medium mb-1">Criar primeiro administrador</p>
                  <p className="text-sm text-yellow-700">
                    Sua conta será configurada como administrador principal do sistema.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <p className="text-xs text-gray-500 text-center">
            ...
            <br />
            Após a criação, você terá acesso completo ao painel administrativo.
          </p>
        </div>
      </div>
    </div>
