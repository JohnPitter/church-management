...
import { MembersBirthdaysTab } from './members/tabs/MembersBirthdaysTab';
import { MembersReportsTab } from './members/tabs/MembersReportsTab';
    ...
    >
        ...
        {activeTab === 'reports' && (
          <MembersReportsTab
            ...
            exportSignatureListToPDF={exportSignatureListToPDF}
            exportSignatureListToWord={exportSignatureListToWord}
